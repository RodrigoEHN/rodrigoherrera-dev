    ...
    <nav className="fixed top-0 left-0 w-full bg-[#0f0f0f]/80 backdrop-blur-md border-b border-gray-800 z-50">
      <div className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8 text-gray-300 text-sm">
          <a href="#about" className="hover:text-[#2ec4b6] transition">
            About
          </a>
          <a href="#experience" className="hover:text-[#2ec4b6] transition">
            Experience
          </a>
      ...
      {open && (
        <div className="md:hidden bg-[#111111] border-t border-gray-800 px-8 py-6 flex flex-col gap-6 text-gray-300 text-sm">
